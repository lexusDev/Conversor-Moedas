...
import { Keyboard ,Text, View, StyleSheet, TextInput, TouchableOpacity } from 'react-native'
...
export default class Conversor extends Component {
    ...
    async converter(){
        ...
        const response = await api.get(`convert?q=${de_para}&compact=ultra&apiKey=27c00746a2ae61afb9d4`);
